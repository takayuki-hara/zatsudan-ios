...
struct R: Rswift.Validatable {
  ...
  struct image {
    /// Image `ApiIcon`.
    static let apiIcon = Rswift.ImageResource(bundle: R.hostingBundle, name: "ApiIcon")
    /// Image `Setting`.
    static let setting = Rswift.ImageResource(bundle: R.hostingBundle, name: "Setting")
    /// Image `YouIcon`.
    static let youIcon = Rswift.ImageResource(bundle: R.hostingBundle, name: "YouIcon")
    
    /// `UIImage(named: "ApiIcon", bundle: ..., traitCollection: ...)`
    static func apiIcon(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.apiIcon, compatibleWith: traitCollection)
    }
    ...
    static func youIcon(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.youIcon, compatibleWith: traitCollection)
    }
